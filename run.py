...
class Runner:
    ...
    def scrape_prices_and_details(
        ...
        if scrape_prodej_byty:
            ...
            data_prodej_byty = self.scraper.scrape_all_with_filter(
                timestamp=full_datetime, category_main_cb=1, category_type_cb=1
            )
        ...
        if scrape_prodej_byty:
            existing_codes = set(
                self.data_manager.get_all_rows("estate_detail")["code"]
            )
    ...
    def run_complete_scraping(
        ...
        self.scrape_prices_and_details(
            scrape_prodej_byty=scrape_prodej_byty, scrape_all=scrape_all
        )
